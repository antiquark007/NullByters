...
#This code is for the all system wiping it has clear option will upgrade it to  the nist wiping
### COMMON FUNCTIONS
...
class WipeApp:
    ...
    def wipe_device(self, device, method):
        ...
        if method == "Zero Fill":
            ...
            # cmd = f"shred -v -n 3 {device} && dd if=/dev/urandom of={device} bs=1M status=progress"
